## FFT	
The program is able to determine a number of bins of an 128 points FFT. It is completely written in AVR Assembler and was tested on an ATmega 1284 with 20 MHz external crystal oscillator. Schematics can be viewed at [atmega_fft_hardware](https://github.com/ncalbrecht/atmega_fft_hardware).
